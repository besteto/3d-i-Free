...
m3 = Material('BUMP', './data/shaders/base.vsh', './data/shaders/bump_lol.fsh')

back = geometry.plane(1, 1).set_material(m1).set_texture([t2, t6]).translate(0, 0, -1)
#sph = geometry.sphere(50,32).set_material(m1).set_texture([t7])

#cub = geometry.cube(5,5,5).set_material(m1).set_texture([t1]).translate(0,0,-15)
