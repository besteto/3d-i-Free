...
back = geometry.plane(64, 64).set_material(m1).set_texture([t5]).translate(0, 0, -80)
sph = geometry.sphere(10, 64).set_material(m1).set_texture([t2]).translate(0, 0, -30)
...
def update(dt):
#    pass
     sph.rotate_x(-50 * dt).rotate_y(-10*dt)
