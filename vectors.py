...
def zero(a): return abs(a) & lt; EPSILON
def equal(a, b): return abs(a - b) & lt; EPSILON
...
class V:
    ...
    def __cmp__(self, other):
        ...
        for i in range(len(self._v)):
            if not equal(self._v[i], other._v[i]):
                if self._v[i] & gt; other._v[i]: return 1
                return -1
        return 0
    ...
    def order(self, order):
        ...
        v = V(self)
        while order & lt; len(v._v):
            v._v.pop()
        while order & gt; len(v._v):
            v._v.append(1.0)
        v._l = None
        return v
...
class C(V):
    ...
    def dot(self):
        raise AttributeError, "C instance has no attribute 'dot'"
...
class Q(V):
    ...
    def dot(self):
        raise AttributeError, "Q instance has no attribute 'dot'"
...
class M(V):
    ...
    def dot(self):
        raise AttributeError, "M instance has no attribute 'dot'"

    def magnitude(self):
        raise AttributeError, "M instance has no attribute 'magnitude'"
    ...
    def row(self, r, v=None):
        ...
        '''
        if r & lt; 0 or r & gt; 3: raise IndexError, 'row index out of range'
    ...
    def col(self, c, v=None):
        ...
        '''
        if c & lt; 0 or c & gt; 3: raise IndexError, 'column index out of range'
...
def nearest(point, neighbors):
    ...
    for other in neighbors:
        ...
        if best is None or d & lt; best[1]:
            best = (other, d)
    return best[0]
...
def farthest(point, neighbors):
    ...
    for other in neighbors:
        d = dsquared(point, other)
        if best is None or d & gt; best[1]:
            best = (other, d)
    return best[0]
